...
jQuery(document).ready(function ($) {
  ...
  if (bkg.UpdateManager.recentUpdate()) {
    var content =
      "<h3>New version recently installed : " +
...
var OptionFormManager = {
  ...
  init: function () {
    ...
    var format_custom_advanced = localStorage["format_custom_advanced"]
      ? localStorage["format_custom_advanced"]
      : "";
    var intelligent_paste =
      localStorage["intelligent_paste"] == "true" ? true : false;
    var walk_all_windows =
      localStorage["walk_all_windows"] == "true" ? true : false;
